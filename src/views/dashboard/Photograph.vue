<template>
  <div ref="avatar" :class="{complete: headerImage}" class="avatar">
    <input id="avatar" type="file" name="" class="avatar-file" accept="image/*" @change="uploadFile">
...
<style lang="scss" scoped>
  .avatar {
    ...
    width: 144px;
    height: 144px;
    background: url('../../assets/ic_pic.png') no-repeat center/contain;
    border-radius: 50%;
