<template>
  <el-main>
    ...
    <el-table
      ...
      <el-table-column label="客户预约日期" prop="APPLEDATE">
        <template slot-scope="scope">
          <template v-if="scope.row.APPLEDATE">
            <el-input v-model="scope.row.APPLEDATE" class="edit-input" placeholder="客户预约日期"/>
          </template>
      ...
      <el-table-column label="登记证书号码" prop="THEDOCUMENTSERIALNO">
        <template slot-scope="scope">
          <template v-if="scope.row.THEDOCUMENTSERIALNO">
            <el-input v-model="scope.row.THEDOCUMENTSERIALNO" class="edit-input" placeholder="登记证书号码"/>
          </template>
      ...
      <el-table-column label="电话号码" prop="PHONENUMBER">
        <template slot-scope="scope">
          <template v-if="scope.row.PHONENUMBER">
            <el-input v-model="scope.row.PHONENUMBER" class="edit-input" placeholder="电话号码"/>
          </template>
