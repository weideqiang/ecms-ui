...
export default {
  ...
  methods: {
    ...
    login: function() { // 查询
      this.$refs.form.validate(valid => {
        if (valid) {
          ...
          this.$http(this.$reportMngApi.getBrnoTrxMonthAvgTime, params).then(
            res => {
    ...
    derive: function() {
      ...
      const params = { 'brno': this.inputForm.brno, 'accdate': '', 'trxno': this.inputForm.trxno, 'sltMonth': this.inputForm.sltMonth, 'dealNumber': 'T0009' }
