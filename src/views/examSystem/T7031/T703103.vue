<template>
  <el-main>
    <div>
      <el-row type="flex" justify="start" class="rowClass70310301">
        <el-col :offset="4" class="colClass703103">
          <el-button :disabled="preQuestion" size="medium" type="primary" @click="preClick()">上一题</el-button>
        </el-col>
        <el-col class="colClass703103">
          ...
          <el-form
            ...
            <el-form-item>
              <el-radio-group v-model="radioOption" size="medium" align="left" @change="selectChange">
                <el-row>
                  <el-radio :label="OptionA" class="el_radio703103" />
                </el-row>
                <el-row align="left">
                  <el-radio :label="OptionB" class="el_radio703103"/>
                </el-row>
              </el-radio-group>
            </el-form-item>
            <el-row>
...
export default {
  ...
  mounted: function() {
    ...
    if (params) {
      ...
      console.log('703103Mounted11: ' + JSON.stringify(this.questionByRandomAlgm))
